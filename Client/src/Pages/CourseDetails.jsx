...
const CourseDetails = () => {
    ...
    useEffect(() => {
  console.log("Course Lecture State:", courseLecture);
  console.log("Video URL => ", courseLecture?.[0]?.videoUrl);
});
  ...
  width="100%"
  height="100%"
  url={courseLecture?.[0]?.videoUrl ? 
      courseLecture[0].videoUrl.replace("http://", "https://") 
      : null}
  controls={true}
/>
                                   </div>
                            ...
                            <CardFooter className="flex p-4">
                              <Button className="bg-gray-900 text-white">Continue Course</Button>
                            </CardFooter>
                        </Card>
                        </div>
                    </div>
